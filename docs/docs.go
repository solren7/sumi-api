                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.CheckEmailRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/bills": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Transaction type: 1 expense, 2 income",
                        "name": "type",
                        "in": "query"
                    },
                    {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/handlers.UpdateBillRequest"
                        }
                    }
                ],
                "responses": {
